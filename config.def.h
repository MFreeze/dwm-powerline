...
static char *tagicons[][NUMTAGS] = {
	[DEFAULT_TAGS]        = { "", "", "", "", "", "", "", "", "", "" },
	[ALTERNATIVE_TAGS]    = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "K" },
...
static const Rule rules[] = {
	...
	RULE(.class = "Gimp", .tags = 1 << 6, .isfloating = 1)
	RULE(.class = "Microsoft Teams", .tags = 1 << 3, .isfloating = 1)
...
static const char *roottermcmd[] = { "st", "-e", "/usr/bin/bash", "-c", "su -", NULL };
static const char *bigtermcmd[] = { "st", "-f", "'Dejavu Sans Mono:pixelsize=20:antialias=true:autohint=true'", NULL };
static const char *web_browser[]  = { "firefox", NULL };
static const char *qt_nvim[] = { "nvim-qt", NULL };

// Audio management
static const char *up_volume[] = { "change_vol", "up", NULL };
static const char *down_volume[] = { "change_vol", "down", NULL };

// Screen locker
static const char *screen_locker[]  = { "slock", NULL };

// PDF reader
static const char *pdf_viewer[] = { "zathura", NULL };
...
static Key keys[] = {
    ...
    { 0,                            XF86XK_ScreenSaver,         spawn,          {.v = screen_locker } },
    { 0,                            XF86XK_Battery,             spawn,          SHCMD("notify-send \"Battery Information\" \"$(acpi)\"") },
    { MODKEY,                       XK_z,                       spawn,          { .v = pdf_viewer } },
